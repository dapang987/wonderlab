...
class HeaderMenu extends Component {
  ...
  /**
   * Deactivate the active item after a short grace period so small pointer gaps
   * between the top-level link and submenu do not collapse the menu.
